...
describe('Upload performance', () => {
  ...
  it('small txt upload completes within PERF.uploadP95Ms', async () => {
    ...
    console.log(`small upload latency: ${durationMs}ms (threshold ${PERF.uploadP95Ms}ms)`)
  ...
  it('large upload completes within PERF.uploadLargeP95Ms', async () => {
    ...
    console.log(`large upload latency: ${durationMs}ms (threshold ${PERF.uploadLargeP95Ms}ms)`)
